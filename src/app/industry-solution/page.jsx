...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-800 overflow-hidden mt-16">
            ...
            <div className="space-y-5 flex flex-col w-full lg:w-2/3 md:items-start items-center p-8 ">
              ...
              <div>
                <p className="text-2xl md:tex-3xl text-gray-50">
                  Transpeed Cargo Pvt Ltd offers secure, efficient, and
                  cost-effective freight solutions by air, sea, and land. We
                  ensure reliable logistics tailored to your needs.
                </p>
              </div>
              <div className="pt-10">
      ...
      <section
        ref={sectionRef}
        className="py-5 md:py-20 relative overflow-hidden"
      >
        <motion.div
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-lg">
              Tailored logistics expertise for every sector, ensuring your
              specific needs are met with precision and care.
            </p>
                          ...
                          >
                            ...
                            <div className="mb-6">
                              <div className="flex items-center mb-4">
                                ...
                                <h4 className="text-xl font-semibold text-[#121d42]">
                                  Our Solutions
                                </h4>
                              </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-10">
                Let Transpeed Cargo handle your industry-specific logistics
                needs with efficiency, security, and reliability.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link
                  href={"contact-us"}
                  className="bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-600 hover:to-teal-600 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
                >
