  ...
  return (
    <div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl bg-sky-800 bg-[url('/images/home-hero.jpg')] bg-blend-multiply bg-cover bg-center border border-b-4 border-t-4 border-gray-100 px-8 py-6 md:w-[450px]"
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  ...
                  <span className="text-2xl leading-[1.6] text-yellow-500 font-bold">
                    {item.title}
                  </span>
                </span>
              </div>
